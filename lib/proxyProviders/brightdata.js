...
// UNCONFIRMED exact per-request cost from a response header. Bright
// Data's own pricing page lists a real published rate for this product
// ("Unlocker API ... Starts from $1/1k req"), but that's not the same as
// a same-response-confirmed value, and it's a different unit (dollars)
// than the arbitrary "credit" numbers ZenRows/Scrape.do report -- same
// reasoning as firecrawl.js and apify-cfbypass.js for returning null
// here rather than a misleadingly precise guess.
