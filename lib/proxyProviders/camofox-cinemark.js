...
module.exports = createCamofoxProvider({
  ...
  batchGapMs: 400,
  // Retire a tab after 8 requests. The limit is a session quota, not a rate --
  // ~11 priced across three runs, unmoved by the gap, first batch fine and the
  // next challenged -- so a fresh session is the lever. 8 sits just under where
