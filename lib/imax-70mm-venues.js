...
// only 24. Treat this list as "the venues we can name", not "every venue".
//
// AMC Rivercenter 11, San Antonio was added from IMAX's own site (via the
// user) after being absent from the article -- one of those missing six. If
// you find another, add it the same way: prefer the chain's theater list for
// coordinates, and record where the venue came from.
//
