...
//
//   Brenden Palms 14 & IMAX, Las Vegas -- city centroid only. Three separate
//   queries returned Concord CA, the wrong casino, and Natick MA. It sits
//   inside the Palms Casino Resort, which geocoders resolve to the resort or
//   miss entirely. Its drive time is therefore approximate for anyone actually
//   in Las Vegas; every other venue is good to the building.
//
...
const IMAX_70MM_VENUES = [
  ...
  { name: "Brenden Palms 14 & IMAX", city: "Las Vegas", state: "NV", lat: 36.1674263, lng: -115.1484131, coordSource: "geocoded (CITY CENTROID -- venue not resolvable, see note)" },
  ...
  { name: "Apple Cinemas Providence Place & IMAX", city: "Providence", state: "RI", lat: 41.82595, lng: -71.415778, coordSource: "geocoded (venue: 1 Providence Pl)" },
