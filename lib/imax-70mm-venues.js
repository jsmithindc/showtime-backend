...
const IMAX_70MM_VENUES = [
  { name: "Harkins Arizona Mills & IMAX", city: "Tempe", state: "AZ", lat: 33.3857002258301, lng: -111.966003417969, chain: "harkins", chainName: "Arizona Mills 18 w/ IMAX", chainCode: "16", coordSource: "harkins list" },
  ...
  { name: "Esquire IMAX Theatre", city: "Sacramento", state: "CA", lat: 38.5785457, lng: -121.490406, coordSource: "geocoded (venue: 1211 K St)", seating: { best: "H", good: ["F"], note: "F22 is solid; a couple of rows further back (around H) would be ideal.", source: "firsthand" } },
  ...
  { name: "Cinemark Seven Bridges & IMAX", city: "Woodridge", state: "IL", lat: 41.7563344, lng: -88.045559, chain: "cinemark", chainName: "Cinemark Seven Bridges and IMAX", chainCode: "276", coordSource: "cinemark list", seating: { best: "G", note: "Row G is solid.", source: "firsthand" } },
  { name: "IMAX, Indiana State Museum", city: "Indianapolis", state: "IN", lat: 39.7688297, lng: -86.1693361, coordSource: "geocoded (venue: 650 W Washington St)", seating: { best: "G", note: "Row G is solid.", source: "firsthand" } },
  ...
  { name: "Brenden Palms 14 & IMAX", city: "Las Vegas", state: "NV", lat: 36.1142332, lng: -115.194245, coordSource: "geocoded (venue: 4321 W Flamingo Rd, confirmed against IMAX's listing)" },
