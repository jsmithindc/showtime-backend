...
async function refresh() {
  ...
  writeDiskCache(CACHE_KEY, { ratings: next, fetchedAt: lastRefreshAt });
  console.error(`IMDb dataset: refreshed ${found} of ${wanted.size} tracked title(s) from the official daily export.`);
  return next;
}
