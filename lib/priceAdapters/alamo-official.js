...
// No auth required. Pricing via GET /s/mother/v1/app/seats/{cinemaId}/{sessionId}.
...
const ALAMO_CINEMAS = [
  ...
  // charlottesville (VA)
  { marketSlug: "charlottesville", cinemaId: "2401", name: "Alamo Drafthouse Charlottesville", lat: 38.012, lng: -78.4995, tz: "America/New_York" },

  // chicago (IL)
  { marketSlug: "chicago", cinemaId: "1801", name: "Alamo Drafthouse Wrigleyville", lat: 39.5843, lng: -105.0264, tz: "America/Chicago" },

  // corpus-christi (TX)
  { marketSlug: "corpus-christi", cinemaId: "2001", name: "Alamo Drafthouse Corpus Christi", lat: 27.665, lng: -97.3978, tz: "America/Chicago" },

  // dc-metro-area (VA)
  { marketSlug: "dc-metro-area", cinemaId: "1102", name: "Alamo Drafthouse Crystal City", lat: 38.8587, lng: -77.0493, tz: "America/New_York" },
  { marketSlug: "dc-metro-area", cinemaId: "1101", name: "Alamo Drafthouse DC Bryant Street", lat: 38.92031, lng: -76.99928, tz: "America/New_York" },
  ...
  // dfw (TX)
  { marketSlug: "dfw", cinemaId: "0702", name: "Alamo Drafthouse Cedars", lat: 32.7699, lng: -96.7995, tz: "America/Chicago" },
  { marketSlug: "dfw", cinemaId: "0707", name: "Alamo Drafthouse Denton", lat: 33.225, lng: -97.1686, tz: "America/Chicago" },
  { marketSlug: "dfw", cinemaId: "0706", name: "Alamo Drafthouse Lake Highlands", lat: 32.8675, lng: -96.7415, tz: "America/Chicago" },
  { marketSlug: "dfw", cinemaId: "0703", name: "Alamo Drafthouse Las Colinas", lat: 32.8748, lng: -96.9442, tz: "America/Chicago" },
  { marketSlug: "dfw", cinemaId: "0701", name: "Alamo Drafthouse Richardson", lat: 32.9493, lng: -96.7385, tz: "America/Chicago" },

  // indianapolis (IN)
  { marketSlug: "indianapolis", cinemaId: "3101", name: "Alamo Drafthouse Indianapolis", lat: 39.8273334497065, lng: -86.23949151534, tz: "America/New_York" },

  // laredo (TX)
  { marketSlug: "laredo", cinemaId: "1501", name: "Alamo Drafthouse Laredo", lat: 27.6139, lng: -99.4711, tz: "America/Chicago" },

  // los-angeles (CA)
  { marketSlug: "los-angeles", cinemaId: "1701", name: "Alamo Drafthouse DTLA", lat: 34.0482, lng: -118.2588, tz: "America/Los_Angeles" },

  // northern-virginia (VA)
  { marketSlug: "northern-virginia", cinemaId: "0501", name: "Alamo Drafthouse Loudoun", lat: 39.052, lng: -77.4551, tz: "America/New_York" },
  { marketSlug: "northern-virginia", cinemaId: "0502", name: "Alamo Drafthouse Woodbridge", lat: 38.6273, lng: -77.2876, tz: "America/New_York" },
  ...
  { marketSlug: "nyc", cinemaId: "2102", name: "Alamo Drafthouse Staten Island", lat: 40.56632694287531, lng: -74.10995274442374, tz: "America/New_York" },
  ...
  // sf (CA)
  { marketSlug: "sf", cinemaId: "0803", name: "Alamo Drafthouse Mountain View", lat: 37.4049, lng: -122.112, tz: "America/Los_Angeles" },
  { marketSlug: "sf", cinemaId: "0801", name: "Alamo Drafthouse San Francisco", lat: 37.7563, lng: -122.4192, tz: "America/Los_Angeles" },
  { marketSlug: "sf", cinemaId: "0802", name: "Alamo Drafthouse Valley Fair", lat: 37.323, lng: -121.9637, tz: "America/Los_Angeles" },

  // southwest-florida (FL)
  { marketSlug: "southwest-florida", cinemaId: "3201", name: "Alamo Drafthouse Naples", lat: 26.2526, lng: -81.7989, tz: "America/New_York" },

  // springfield (MO)
  { marketSlug: "springfield", cinemaId: "2301", name: "Alamo Drafthouse Springfield", lat: 37.142, lng: -93.2946, tz: "America/Chicago" },

  // st-louis (MO)
  { marketSlug: "st-louis", cinemaId: "2601", name: "Alamo Drafthouse City Foundry", lat: 38.633935, lng: -90.240263, tz: "America/Chicago" },

  // twin-cities (MN)
  { marketSlug: "twin-cities", cinemaId: "2501", name: "Alamo Drafthouse Woodbury", lat: 44.9472, lng: -92.9266, tz: "America/Chicago" },

  // winchester (VA)
  { marketSlug: "winchester", cinemaId: "0301", name: "Alamo Drafthouse Winchester", lat: 39.1191, lng: -78.1943, tz: "America/New_York" },

  // yonkers (NY)
  { marketSlug: "yonkers", cinemaId: "0901", name: "Alamo Drafthouse Yonkers", lat: 40.982602, lng: -73.824461, tz: "America/New_York" },
];
...
// Confirmed slug set from live API 2026-08-25: 2d-digital, hdr, 35mm, 70mm, open-caption.
// "BD" appears only as a sessionAttributeSlug (Vista label), not a formatSlug -- ignored here.
function alamoDisplayFormat(formatSlug) {
  ...
  if (s === "hdr") return "HDR";
  if (s === "open-caption") return "Open Caption";
  ...
  if (s === "digital" || s === "standard" || s === "2d" || s === "2d-digital") return "Standard";
 ...
 *
 * Filtering by movieTitle, dateISO, and session status happens here.
 */
async function getAlamoShowtimesForCinemas({ cinemas, movieTitle, dateISO }) {
  ...
  await Promise.all(
    [...byMarket.entries()].map(async ([marketSlug]) => {
      ...
      for (const sess of sessions) {
        ...
        if (!cinema) continue;
        // Skip sold-out and cancelled sessions -- no bookable tickets
        if (sess.status === "SOLDOUT" || sess.status === "CANCELLED") continue;

        const title = titleBySlug.get(sess.presentationSlug);
        // Falsy movieTitle means "everything at this cinema" -- see the note
        ...
        // Session-specific URL: lands directly on seat selection
        const bookingLink = `https://drafthouse.com/${marketSlug}/show/${sess.presentationSlug}?cinemaId=${cinema.cinemaId}&showSeats=true&sessionId=${sess.sessionId}`;
 ...
 * CONFIRMED REAL 2026-08-25: Austin $7.58, DTLA $9.00. No auth required. One GET per session.
 *
