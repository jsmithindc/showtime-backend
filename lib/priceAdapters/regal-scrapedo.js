...
async function createOrderSession({ cinemaCode, costTracker }) {
  ...
  // needsRender intentionally NOT set: FlareSolverr/Byparr sends postData
  // as form-encoded, not JSON, so Regal returns HTML instead of an order
  // response. Bright Data's sync path (direct HTTP) handles JSON POST correctly.
